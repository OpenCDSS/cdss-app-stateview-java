@echo off
rem Configure and run Eclipse Neon 3 32-bit Windows for standard StateView development environment.
...
rem - %USERPROFILE%\cdss-dev\StateView\git-repos\cdss-app-stateview-java
...
rem - additional "standard" installation locations can be added for StateView developers
set eclipseExe=""
...
rem - this is 32-bit given StateView is not yet 64-bit
...
title Eclipse configured for StateView development
